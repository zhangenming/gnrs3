...
export function 更新敌方开塔提示(数据包) {
  ...
  const 新增推断开塔数 = 应用敌方成功开塔推断(上次快照, 当前快照, 判断)
...
function 取得敌方开塔判断(上次快照, 当前快照) {
  ...
  const 自然兵力差变化 =
    大回合增长次数 * (上次快照.敌方.陆地 - 上次快照.我方.陆地) +
    二回合增长次数 * (上次快照.敌方.塔数 - 上次快照.我方.塔数)
